...
Metric 2 — Tone Alignment Score   (LLM-as-Judge via Qwen3 32B)
Metric 3 — Email Quality Score    (LLM-as-Judge via Qwen3 32B)
"""
...
METRIC_2_DEFINITION = {
    ...
    "type": "LLM-as-Judge",
    "description": (
        "Uses Qwen3 32B as an impartial judge to rate how well the "
...
def tone_alignment_score(tone: str, email_text: str) -> float:
    """
    Compute Tone Alignment Score using Groq (qwen/qwen3-32b) as judge.
...
METRIC_3_DEFINITION = {
    ...
    "type": "LLM-as-Judge",
    "description": (
        "Uses Qwen3 32B as an impartial judge to rate the holistic quality "
...
def email_quality_score(email_text: str) -> float:
    """
    Compute Email Quality Score using Groq (qwen/qwen3-32b) as judge.
